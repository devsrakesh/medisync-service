...
__decorate([
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.IsEnum)(['consultation', 'diagnostic', 'follow-up']),
    __metadata("design:type", String)
...
__decorate([
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.IsEnum)(['scheduled', 'confirmed', 'canceled', 'completed']),
    __metadata("design:type", String)
...
], CreateAppointmentDto.prototype, "confirmation", void 0);
